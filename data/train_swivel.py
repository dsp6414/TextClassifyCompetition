...
flags.DEFINE_string(
    'input_base_path', '/home/xiaqiang/total_data/daguanbei/word_swivel_data',
    'Directory containing input shards, vocabularies, and marginals.')
flags.DEFINE_string(
    'output_base_path', '/home/xiaqiang/total_data/daguanbei/word_swivel_data',
...
flags.DEFINE_integer(
    'submatrix_rows', 1024, 'Number of rows in each submatrix')
flags.DEFINE_integer(
    'submatrix_cols', 1024, 'Number of cols in each submatrix')
...
class Model(object):
  ...
  def _count_matrix_input(self, filenames, submatrix_rows, submatrix_cols):
    ...
    features = tf.parse_single_example(
        serialized_example,
        features={
            'global_row': tf.FixedLenSequenceFeature([submatrix_rows], dtype=tf.int64, allow_missing=True),
            'global_col': tf.FixedLenSequenceFeature([submatrix_cols], dtype=tf.int64, allow_missing=True ),
